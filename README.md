...
A Simple Activity Stream React-Redux component

here is the mock
<img src="./public/images/mock.jpg" >
...
Best viewed in chrome browser tools (mobile mode/responsive settings) 

recommend node -v 6.9.4 and npm 3.10.10
